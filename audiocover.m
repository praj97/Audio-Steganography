%assigning path of the files
msg_txt = fileread('F:\Minor_Project\Test1\Secret Message\smsg.txt');
infile = 'F:\Minor_Project\Test1\Sounds\train.wav';
outfile = 'F:\Minor_Project\Test1\Sounds\trainOut.wav';
